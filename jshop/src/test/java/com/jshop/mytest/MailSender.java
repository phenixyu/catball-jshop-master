...
public class MailSender {
        ...
        public static String myEmailAccount = "yuyongjian1314@163.com";
        public static String myEmailPassword = "PhenixSophia";
        ...
        // 收件人邮箱（替换为自己知道的有效邮箱）
        public static String receiveMailAccount = "jshop123@sina.cn";
    ...
    public static void main(String[] args) throws Exception {
        ...
        transport.sendMessage(message, receiver);
